        ...
        <div class='wrapper'>
          ...
          <div class='slider'>
            <div id="owl-demo" class="owl-carousel owl-theme">
              <div class="item"><img src="../assets/img/arts/2014/kunstwerk/map-eu.jpg" alt=""></div>
              <div class="item"><img src="http://www.swarez.co.uk/wp-content/uploads/2010/09/Abstract-Art-Painting-The-Satch1.jpg" alt="GTA V"></div>
              <div class="item"><img src="http://jenniferlevimorrison.files.wordpress.com/2010/10/painthorsespiritssmallpix.jpg" alt="Mirror Edge"></div>
            </div>
          </div>
        </div>
